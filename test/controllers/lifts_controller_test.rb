...
class LiftsControllerTest < ActionController::TestCase
  ...
  test "should create lift" do
    assert_difference('Lift.count') do
      post :create, lift: { name: @lift.name, rep: @lift.rep, type: @lift.type, userId: @lift.userId, weight: @lift.weight }
    end
  ...
  test "should update lift" do
    patch :update, id: @lift, lift: { name: @lift.name, rep: @lift.rep, type: @lift.type, userId: @lift.userId, weight: @lift.weight }
    assert_redirected_to lift_path(assigns(:lift))
  end
